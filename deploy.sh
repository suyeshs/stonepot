...
# Deploy Stonepot API (Bun) with integrated Next.js client to Cloud Run

set -e

PROJECT_ID="sahamati-labs"  # Update this with your GCP project ID
REGION="us-central1"
SERVICE_NAME="stonepot-api"
IMAGE_NAME="gcr.io/${PROJECT_ID}/stonepot-backend"

echo "🚀 Deploying Stonepot API (Bun) + Next.js Client to Cloud Run"
echo "=========================================="
